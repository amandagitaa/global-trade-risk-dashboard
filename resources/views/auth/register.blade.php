...
@section('title', 'Register - Global Trade Intelligence')
            ...
            <div class="login-card p-5 w-100 fade-in" style="max-width: 500px;">
                ...
                <div class="text-center mb-5">
                    <div class="d-inline-flex align-items-center justify-content-center bg-soft-orange rounded-circle p-3 mb-3 shadow-sm" style="width: 70px; height: 70px;">
                        <i class="bi bi-person-plus fs-2 text-orange"></i>
                    </div>
                    <h3 class="fw-bold text-dark mb-1">Create Account</h3>
                    <p class="text-muted">Create your account to access the Global Trade Intelligence Platform.</p>
                </div>
                ...
                {{-- Form --}}
                <form method="POST" action="https://global-trade-risk-dashboard-production.up.railway.app/register" id="loginForm">
                    @csrf

                    {{-- Name --}}
                    <div class="mb-3">
                        <label for="name" class="form-label fw-bold text-dark small text-uppercase">Full Name <span class="text-danger">*</span></label>
                    ...
                    {{-- Email --}}
                    <div class="mb-3">
                        <label for="email" class="form-label fw-bold text-dark small text-uppercase">Email Address <span class="text-danger">*</span></label>
                        <div class="input-group premium-input-group">
                            <span class="input-group-text bg-white border-end-0 text-muted ps-3">
                    ...
                    <div class="mb-3">
                        <label for="company_name" class="form-label fw-bold text-dark small text-uppercase">Company Name</label>
                        <div class="input-group premium-input-group">
                            <span class="input-group-text bg-white border-end-0 text-muted ps-3">
                    ...
                    {{-- Country --}}
                    <div class="mb-3">
                        <label for="country" class="form-label fw-bold text-dark small text-uppercase">Country <span class="text-danger">*</span></label>
                        <div class="input-group premium-input-group">
                            <span class="input-group-text bg-white border-end-0 text-muted ps-3">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <label for="password" class="form-label fw-bold text-dark small text-uppercase">Password <span class="text-danger">*</span></label>
                            <div class="input-group premium-input-group">
                                <span class="input-group-text bg-white border-end-0 text-muted ps-3">
                        ...
                        <div class="col-md-6">
                            <label for="password_confirmation" class="form-label fw-bold text-dark small text-uppercase">Confirm Password <span class="text-danger">*</span></label>
                            <div class="input-group premium-input-group">
                                <span class="input-group-text bg-white border-end-0 text-muted ps-3">
                                    <i class="bi bi-lock"></i>
                                </span>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            ...
                            <label class="form-check-label text-muted small fw-semibold" for="terms">
                                I agree to the <a href="#" class="text-orange text-decoration-none">Terms</a> and <a href="#" class="text-orange text-decoration-none">Privacy Policy</a>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="{{ route('login') }}"
                           class="sign-in-link ms-1" style="color: #F59E0B; font-size: 15px; font-weight: 600; cursor: pointer; transition: 0.3s; text-decoration: none;">
                            Sign In
                        </a>
                    </div>
                </form>
