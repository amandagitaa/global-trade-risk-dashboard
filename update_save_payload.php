...
$comparisonResult = [
            ...
            'language_a' => 'N/A', // Assuming not in DB, fallback
            'language_b' => 'N/A',
            ...
            'currency_a' => $countryA->latestCurrency ? $countryA->latestCurrency->status : 'Unknown', // legacy compat
...
echo "CountryComparisonController updated with exhaustive JSON payload.\n";
